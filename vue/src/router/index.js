...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'adminPerson', name: 'AdminPerson', meta: { name: '管理员信息' }, component: () => import('../views/manager/AdminPerson') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'business', name: 'Business', meta: { name: '商品商家' }, component: () => import('../views/front/Business') },
      ...
      { path: 'orders', name: 'Orders', meta: { name: '订单管理' }, component: () => import('../views/front/Orders') },
