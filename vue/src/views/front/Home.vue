<template>
  <div class="main-content">
    <title>常德特产销售系统</title>
    <div style="height: 60px;"></div>
    <div style="display: flex">
      <div class="left"></div>
      <div style="width: 66%; background-color: white;">
        <div style="color: #FE0137FF; margin: 15px 0 15px 18px; font-weight: bold; font-size: 16px">特产分类</div>
...
<!--            分类栏-->
          ...
          <div style="flex: 3; background-color: #F3F3F3FF; margin-top: 15px; margin-left: 15px; border-radius: 10px">
            ...
            <div style="margin-top: 20px; padding: 0 15px">
              <img src="../../assets/imgs/bg2.jpg" alt="" style="height: 150px; width: 100%; border-radius: 20px">
            </div>
        ...
        <div style="margin: 10px 5px 0 5px">
          <el-row>
            <el-col :span="5" v-for="item in goodsData">
              ...
              <div style="margin-top: 5px; font-size: 20px; color: #FF5000FF">￥ {{item.price}}元 / {{item.unit}}</div>
            </el-col>
          </el-row>
        </div>
<!--商品推荐-->
