        ...
        <div style="margin: 20px 0; padding: 0 50px">
          <div class="table">
            <el-table :data="goodsData" strip @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="goodsName" label="商品名称" width="240px" align="center">
                <template v-slot="scope">
              ...
              <el-table-column prop="goodsPrice" label="商品单价(元)" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    loadAddress() {
      this.$request.get('/address/selectByUserId/'+this.user.id).then(res => {
        if (res.code === '200') {
