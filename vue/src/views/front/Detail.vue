<template>
  <div class="main-content">
    <div style="width: 60%; background-color: #e4e7ed; min-height: 1000px; margin: 20px auto; border-radius: 20px">
      <div style="padding: 15px 20px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            ...
            <div style="color: red; margin-top: 15px">疯抢价：<span style="font-size: 20px">{{goodsData.price}} 元 / {{goodsData.unit}}</span></div>
            <div style="margin-top: 20px">
              <img src="../../assets/imgs/logo4.png" alt="" style="width: 70%; height: 130px; border-radius: 15px">
            </div>
              ...
              <div style="margin-top: 20px" v-for="item in commentData">
                <div style="display: flex">
                  <div style="width: 40px">
                    <img :src="item.userAvatar" alt="" style="height: 45px; width: 45px; border-radius: 50%">
                  </div>
...
export default {
  ...
  data() {
    let goodsId = this.$route.query.id//获取浏览器带来的参数
    return {
      user: JSON.parse(localStorage.getItem('xm-user') || '{}'),
      goodsId: goodsId,//接受参数
      goodsData: {},
      activeName: 'first',
      commentData:{},
    }
