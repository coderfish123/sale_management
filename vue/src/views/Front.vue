  ...
  <div>
    ...
    <div class="front-header">
      <div class="front-header-left">
        <img src="@/assets/imgs/logo.png" alt="" @click="navTo('/front/home')" style="width: 50px;height: 50px">
        <p style="font-size: 25px">常德特产销售系统</p>
      </div>
      ...
      <div class="front-header-right">
        <div v-if="!user.username" style="flex: inherit">
        ...
        <div v-else>
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <div style="text-decoration: none" @click="navTo('/front/person')">个人信息</div>
              </el-dropdown-item>
              <el-dropdown-item>
              ...
              <el-dropdown-item>
                <div style="text-decoration: none" @click="navTo('/front/cart')">购物车</div>
              </el-dropdown-item>
              <el-dropdown-item>
